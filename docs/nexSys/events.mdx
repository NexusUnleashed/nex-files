...
Triggered when any affliction is gained by the player.

## AffLost

Triggered when any affliction is lost by the player.

## \<affliction\>GotAffEvent

Triggered when a specific affliction is gained by the player. Replace `\<affliction\>` with the actual affliction name.

## \<affliction\>LostAffEvent

Triggered when a specific affliction is lost by the player. Replace `\<affliction\>` with the actual affliction name.

## DefGot

Triggered when any defense is gained by the player.

## DefLost

Triggered when any defense is lost by the player.

## \<defence\>GotDefEvent

Triggered when a specific defense is gained by the player. Replace `\<defence\>` with the actual defense name.

## \<defence\>LostDefEvent

Triggered when a specific defense is lost by the player. Replace `\<defence\>` with the actual defense name.
...
Triggered when an item has been added to the current room.

## ItemAddedToInv

Triggered when an item has been added to the inventory.

## ItemRemovedFromRoom

Triggered when an item has been removed from the current room.

## ItemRemoveFromInv

Triggered when an item has been removed from the inventory.

## ItemUpdatedRoom

Triggered when an item in the room has been updated.

## ItemUpdatedInv

Triggered when an item in the inventory has been updated.

## ItemListForRoom

Triggered when the list of items in the current room has been updated.

## ItemListForInv

Triggered when the list of items in the inventory has been updated.

## TargetSetEvent

Triggered when a new target has been set.

## TargetChanged

Triggered when the current target has been changed.

## ClassChanged

Triggered when the player’s class has changed.

## HealthUpdated

Triggered when the player’s health has been updated.

## ManaUpdated

Triggered when the player’s mana has been updated.

## RageUpdated

Triggered when the player’s rage has been updated.
