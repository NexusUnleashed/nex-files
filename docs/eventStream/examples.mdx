...
Many packages, like [nexMap4](/docs/nexmap/introduction), [nexGui4](/docs/nexgui/introduction), and [nexSys4](/docs/nexsys/introduction), create and handle custom events that users can hook into. nexSys, for example, raises events for afflictions, defences, items, and other state changes.
